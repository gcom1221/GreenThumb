...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.feature-card, .service-card, .milestone-content');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    milestones.forEach((milestone, index) => {
        ...
        const isRight = milestone.classList.contains('milestone-right');
        
        content.style.opacity = '0';
        content.style.transform = `translateX(${isRight ? '50px' : '-50px'})`;
